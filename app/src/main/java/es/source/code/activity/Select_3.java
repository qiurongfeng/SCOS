...
public class Select_3 extends Activity {
    ...
    private EditText mTwoNum,mTwoCheck,mThreeNum,mThreeCheck;
...
//                Toast.makeText(Select_3.this, "点击的是第" + i, Toast.LENGTH_LONG).show();
                if (i == 0){
                    buildingNo = "5";
                }
                if (i == 1){
...
//                Log.d("sssssssss",sharedPreferences.getString(buildingNo,""));
                if (sharedPreferences.getString(buildingNo,"").equals("0")){
                    Toast.makeText(Select_3.this,"该楼已经被选完！",Toast.LENGTH_LONG).show();
                    finish();
                    Intent i =new Intent(Select_3.this,Select_1.class);
                    startActivity(i);
                    Select_3.this.finish();
                    return;
                }
                postMessage();
            }
            ...
            switch (msg.what) {
                case RESPONSE:
                    ...
                    if (info.get("errcode").equals("0")) {
                        ...
                        Toast.makeText(Select_3.this, "发生未知错误！", Toast.LENGTH_LONG).show();
                        Intent i = new Intent(Select_3.this, MainScreen.class);
                        startActivity(i);
                        finish();
                    }
    ...
    private void refresh() {
        finish();
        Intent intent = new Intent(Select_3.this, Select_1.class);
    ...
    private void postMessage() {
        ...
        String username = sharedPreferences.getString("studentid", "null");
//
        String data = "num=1" + "&stuid=" + username +"&stu1id"+ stu1id+"&v1code"+v1code +"&stu2id"+ stu2id+"&v2code"+v2code+ "&buildingNo=" + buildingNo;
            ...
            public void run() {
                ...
                try {
                    ...
                    if (errcode.equals("0")){
                        ...
                        editor.commit();
                        Intent i = new Intent(Select_3.this,ChooseSucess.class);
                        startActivity(i);
                        finish();
                    }else {
                        Toast.makeText(Select_3.this,"选择失败！！",Toast.LENGTH_LONG).show();
