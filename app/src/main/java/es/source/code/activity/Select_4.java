...
public class Select_4 extends Activity{
    private TextView mName, mNumber, mSex, mLocation, mGrade, mVcode, mFive, mNine, mEight, mShisan, mShisi;
    private EditText mTwoNum,mTwoCheck,mThreeNum,mThreeCheck,mFourNum,mFourCheck;
...
//                Log.d("sssssssss",sharedPreferences.getString(buildingNo,""));
                if (sharedPreferences.getString(buildingNo,"").equals("0")){
                    Toast.makeText(Select_4.this,"该楼已经被选完！",Toast.LENGTH_LONG).show();
                    finish();
                    Intent i =new Intent(Select_4.this,Select_1.class);
                    startActivity(i);
                    Select_4.this.finish();
                    return;
                }
                postMessage();
            }
    ...
    private void isChoice(){
        ...
        if (choice_status.equals("1")){
            Toast.makeText(Select_4.this,"您已经选择成功！",Toast.LENGTH_LONG).show();
            Intent i = new Intent(Select_4.this,Check.class);
            startActivity(i);
            finish();
        }
    }
    ...
    private void initView() {
        ...
        mThreeNum = findViewById(R.id.three_number);
        mThreeCheck = findViewById(R.id.three_check);
        mFourNum = findViewById(R.id.four_number);
        mFourCheck = findViewById(R.id.four_check);
    }
            ...
            switch (msg.what) {
                case RESPONSE:
                    ...
                    if (info.get("errcode").equals("0")) {
                        ...
                        Toast.makeText(Select_4.this, "发生未知错误！", Toast.LENGTH_LONG).show();
                        Intent i = new Intent(Select_4.this, MainScreen.class);
                        startActivity(i);
                        finish();
                    }
    ...
    private void refresh() {
        finish();
        Intent intent = new Intent(Select_4.this, Select_1.class);
        startActivity(intent);
    }
    private void postMessage() {
        String stu1id = mTwoNum.getText().toString();
        String v1code = mTwoCheck.getText().toString();
        String stu2id = mThreeNum.getText().toString();
        String v2code = mThreeCheck.getText().toString();
        String stu3id = mFourNum.getText().toString();
        String v3code = mFourCheck.getText().toString();

        SharedPreferences sharedPreferences = getSharedPreferences("shared", MODE_PRIVATE);
        String username = sharedPreferences.getString("studentid", "null");

        String data = "num=1" + "&stuid=" + username +"&stu1id"+ stu1id+"&v1code"+v1code +"&stu2id"+ stu2id+"&v2code"+v2code+"&stu3id"+ stu3id+"&v3code"+v3code+ "&buildingNo=" + buildingNo;
            ...
            public void run() {
                ...
                try {
                    ...
                    if (errcode.equals("0")){
                        ...
                        editor.commit();
                        Intent i = new Intent(Select_4.this,ChooseSucess.class);
                        startActivity(i);
                        finish();
                    }else {
                        Toast.makeText(Select_4.this,"选择失败！！",Toast.LENGTH_LONG).show();
